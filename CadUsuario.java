...
public class CadUsuario {
    ...
    public CadUsuario(String emailUser) {
        this.emailUser = emailUser;
    }

    public CadUsuario(String nomeUser, String emailUser, String raUser, String senhaUser, Date dasNascUser, String tipoUser, Date dataCadUser, String sexoUser) {
    ...
    public CadUsuario(int idUser, String nomeUser, String emailUser, String raUser, String senhaUser, Date dasNascUser, String tipoUser, Date dataCadUser, String sexoUser) {
        this.idUser = idUser;
        this.nomeUser = nomeUser;
        this.emailUser = emailUser;
        this.raUser = raUser;
...
// Setters Meteodos Modificadores
    ...
    private static CadUsuario intanciaUnica;

    public static synchronized CadUsuario getInstance() {
        if (intanciaUnica == null) {
            intanciaUnica = new CadUsuario();
        }
