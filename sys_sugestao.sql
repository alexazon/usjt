...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Nov-2016 às 00:55
...
CREATE TABLE `cad_sugestao` (
  ...
  `titulo_sugestao` varchar(45) NOT NULL,
...
(1, '2016-11-15', NULL, 'Hello Word', 'Essa é a primeira sugestão do sistema de Sugestões e Devolutivas', 1, 1, 1);
...
(1, 'Alex Oliveira', 'admin', '81616584', 'admin', '1996-09-30', 'colaborador', '2016-11-15', 'Masculino');
...
ALTER TABLE `aso_user_categoria`
  ...
  ADD KEY `fk_aso_user_categoria_cad_sugestao1_idx` (`id_sugestao`);
...
--
ALTER TABLE `aso_user_categoria`
  MODIFY `id_aso` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `aso_user_categoria`
  ...
  ADD CONSTRAINT `fk_aso_user_categoria_cad_sugestao1` FOREIGN KEY (`id_sugestao`) REFERENCES `cad_sugestao` (`id_sugestao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
